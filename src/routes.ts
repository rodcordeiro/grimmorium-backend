...
routes.put('/collections/:id', isAuthenticated, collections.update);
routes.post('/collections/share', isAuthenticated, collections.share);
routes.delete('/collections/:id', isAuthenticated, collections.delete);
